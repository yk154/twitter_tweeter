...
var Client = /** @class */ (function () {
    ...
    Client.prototype.login = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            var token, authenticated, secret, url, e_3, cloud;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        token = null;
    ...
    Client.prototype.deploy = function (name, stage, types, dryRun, subscriptions, secrets, force) {
        return __awaiter(this, void 0, void 0, function () {
            var oldMutation, newMutation, deploy, e_5, deploy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        e_5 = _a.sent();
                        if (!e_5.message.includes("Field 'force' is not defined in the input type")) return [3 /*break*/, 5];
